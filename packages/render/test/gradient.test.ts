...
describe('sampleStops', () => {
  ...
  it('interpolates in the working space', () => {
    ...
    expect(c.c1).toBeCloseTo(0.5, 3);
    expect(c.c3).toBeCloseTo(0.5, 3);
  });
...
describe('sampleRadial', () => {
  ...
  it('returns the first stop at the center', () => {
    ...
    expect(c.c1).toBeCloseTo(1, 3);
    expect(c.alpha).toBeCloseTo(1, 3);
  });
...
describe('sampleMultiStop', () => {
  ...
  it('interpolates between adjacent stops', () => {
    ...
    expect(c.c1).toBeGreaterThan(0);
    expect(c.c2).toBeGreaterThan(0);
    expect(c.c3).toBeLessThan(0.1);
  });
});
